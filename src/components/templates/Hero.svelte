...
<section class="hero">
	...
	<div class="text">
		<Title
			heading="Sebarkan kabar bahagiamu dalam satu genggaman"
	...
	<div class="photo">
		<img class="image" src={HeroPhoto} alt="Bikin Undangan Mantap" />
	</div>
</section>

<style lang="postcss">
	.hero {
		@apply relative py-5 xl:grid xl:grid-cols-12 xl:place-items-center xl:gap-[30px] xl:py-8;
	}

	.text {
		@apply mb-12 xl:col-span-6 xl:mb-0;
	}
